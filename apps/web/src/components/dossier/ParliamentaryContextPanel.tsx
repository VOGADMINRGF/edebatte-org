    ...
    <section id="parlamentarischer-kontext" className="space-y-4 border-t border-[rgb(var(--border))] pt-5">
      <div className="space-y-1">
        ...
        <p className="text-xs text-[rgb(var(--muted))]">
          Offizieller Verfahrensstand und öffentliche Aussagen werden getrennt dargestellt. Daten von
          abgeordnetenwatch werden als offene Drittquelle genutzt; Eigenaussagen von Abgeordneten sind keine
          Faktenbewertung.
        </p>
      </div>
