        ...
        <div className="rounded-3xl bg-white/90 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.08)] ring-1 ring-slate-100 md:p-10">
          <header className="space-y-3 text-center">
            ...
            <p className="text-sm leading-relaxed text-slate-700 md:text-base">
              Hier findest du die Widerrufsbelehrung fuer entgeltliche Leistungen,
              sofern sie anwendbar ist. Wir finalisieren die rechtsverbindliche
              Fassung und stellen sie hier bereit.
            </p>
          </header>
          ...
          <div className="mt-8 grid gap-4">
            <InfoCard
              ...
              body="Die Widerrufsbelehrung wird derzeit rechtlich finalisiert. Sobald
sie vorliegt, veroeffentlichen wir sie an dieser Stelle."
            />
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50/70 p-4 text-sm text-slate-800">
              ...
              <p className="mt-2">
                Wenn du Fragen zum Widerruf hast, melde dich direkt bei uns:
              </p>
              <a
