...
export const metadata: Metadata = {
  title: "Beauftragung – VoiceOpenGov & eDebatte",
  description:
    "VoiceOpenGov-Beitrag und eDebatte-Paket auswählen, Beitrag berechnen und Auftrag abschließen.",
};
...
export default function MitgliedWerdenPage() {
  return (
    <main
      ...
      aria-label="VoiceOpenGov Beauftragung"
    >
      <section
