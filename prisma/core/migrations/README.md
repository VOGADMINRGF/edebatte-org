# Core Prisma migrations

This directory is the canonical migration history for `prisma/core/schema.prisma`.

Rules:

- Generate migrations only against `prisma/core/schema.prisma`.
- Do not use `prisma/migrations/` as a deploy source for Core.
