...
Basis: `main@bc84c51efcc9656d16dfea20589ce84f43f336ce`
...
| C3B | `CREATE-ANONYMOUS-ABUSE-ROUTE-SECURITY-01` | Same-Origin/Fetch Metadata/CSRF, Honeypot einschließlich minimalem nicht sichtbarem `CreateClient`-Trap, persistente Actor-/IP-/Session-/Client-Limits, Cooldown, expliziter Content-Type, vor dem Parse gemessene Body-Grenze, malformed/unknown/unsupported fail-closed, unavailable limiter fail-closed | Planner-/Intake-Fachsemantik, Claim/Single Flight/PII-URL-Analyse, sichtbare Browser-UI über den begrenzten Trap hinaus, Adoption und Account Draft | `review`; implementiert in PR `#744` auf Exact Head `5c52b7ff7f30d185182426ec6d0286dc9d97361b`; Merge-Annahme ausstehend; noch nicht `done`; neue oder doppelte Implementierungsautorisierung geschlossen |
