...
| C3 | Anonymous Session, Abuse Gates und redacted Guest Claim | `#724`, `#682` | Parent `blocked`; C3A über PR `#740` done; C3B über PR `#744` auf Head `c697fe225339e8f9e923b37506d84214d69068a2` done; C3C `CREATE-GUEST-CLAIM-PII-SAFETY-01` über PR `#748` auf Head `00c54ae5fcc42e005955ed8854287e585331750c` done; nur C3D `CREATE-GUEST-EPHEMERAL-UI-01` `codex_ready`/`preflight_only`/`implementation_authorized=false` |
...
Dieses Runbook autorisiert weder den C3-Parent noch C3B oder C3C zu einer neuen oder doppelten Implementierung noch C3D zur Implementierung. C3A ist über PR `#740` gemergt; C3B ist über PR `#744`, Implementation Head `c697fe225339e8f9e923b37506d84214d69068a2`, als `main@91ac96aa8dc12ab38e4912b6e4d29807f124cde4` gemergt und `done`; C3C ist über PR `#748`, Implementation Head `00c54ae5fcc42e005955ed8854287e585331750c`, als `main@932d01e6a85c55e6763f070647c2d67513248e36` gemergt und `done`. Ausschließlich C3D ist `codex_ready` mit `AUTHORIZATION=preflight_only` und `IMPLEMENTATION_AUTHORIZED=false`; C3D ist nicht `done`. C4–C12 und G1–G5 bleiben nicht autorisiert. Dieses Runbook autorisiert kein Deployment, keine Production-DB-Arbeit, keine Secret-/Provideraktivierung und keine Änderung an `#590`, `#682`, `#724` oder `#727`. Produktweite Parallel-Lanes und Production Gates werden ausschließlich im Master-Roadmap-Dokument eingeordnet.
